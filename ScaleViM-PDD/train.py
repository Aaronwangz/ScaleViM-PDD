...
if __name__ == "__main__":
    ...
    if opt.epoch != 0:
        generator.load_state_dict(torch.load('train_result_RSID_pb1/prebest.pth'), strict=True)
    else:
    ...
    train_root = r'E:\Mymodel\data\RSID'
    val_roots = [r'E:\Mymodel\data\RSID\test']
    ...
    prev_time = time.time()
    step = 0
    save_dir = 'train_result_RSID_pb1'
    ...
    for epoch in range(opt.epoch, opt.n_epochs):
        ...
        best_model_state = generator.module.state_dict() if isinstance(generator,
